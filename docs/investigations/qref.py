"""Find 8-byte pointers to an RVA: vtable slots and data tables.

Usage: python qref.py <rva hex>

Use xref.py instead when looking for a lea or a call, which store a 32-bit
RIP-relative displacement rather than a whole pointer.

Copied unchanged from Master Looter's docs/investigations on 10 September 2026
so this mod carries its own copy.
"""
